...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      '/guides/': [
        {
          ...
          items: [
            ...
            { text: 'Strict Mode', link: '/guides/strict-mode' },
      ...
      '/gin/': [
        {
          text: 'gin — LLM-authorable runtime',
          items: [
            { text: 'Overview', link: '/gin/' },
            { text: 'Type System', link: '/gin/types' },
            { text: 'Expressions', link: '/gin/expressions' },
            { text: 'Registry', link: '/gin/registry' },
            { text: 'Built-in Types', link: '/gin/built-ins' },
            { text: 'Diagnostics', link: '/gin/diagnostics' },
          ],
        },
      ],
      '/providers/': [
      ...
      '/examples/': [
        {
          ...
          items: [
            ...
            { text: 'Ginny — Typed Programs', link: '/examples/ginny' },
          ],
        },
      ],
    },
